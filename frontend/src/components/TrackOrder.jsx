                  ...
                  <div className="relative space-y-8 ml-1">
                      ...
                      {orderData.timeline.map((step, idx) => (
                        <div key={idx} className="flex gap-6 relative z-10">
                            <div className={`w-7 h-7 flex items-center justify-center transition-all duration-500 border rounded-none ${
                              step.completed ? 'bg-brand-gold border-brand-gold text-white scale-110 shadow-lg' : 
