...
const ProductCard = ({ product }) => {
  ...
  return (
    ...
    >
      ...
      {/* Modern thin line on hover */}
      <div className="absolute inset-0 border border-brand-pink/0 group-hover:border-brand-pink/20 transition-all pointer-events-none" />
    </motion.div>
  );
};
