               ...
               {[
                 ...
                 <div key={s.id} className="flex flex-col items-center gap-3">
                    <div className={`w-8 h-8 rounded-full flex items-center justify-center transition-all duration-300 border ${
                      step === s.id ? 'bg-[#5C2E3E] text-white border-[#5C2E3E] shadow-lg scale-110' : 
                            ...
                            <div className="flex-1 min-w-0">
                               ...
                               <div className="flex items-center gap-4">
                                  <div className="flex items-center gap-2.5 bg-gray-50 border border-gray-100 px-2 py-0.5 scale-90 -ml-2">
                                     <button onClick={() => updateQuantity(item.id, -1)} className="text-gray-400 hover:text-brand-pink transition-colors">
                                       <FiMinus size={8} />
                                     </button>
                                  ...
                                  <button onClick={() => removeFromCart(item.id)} className="text-[#5C2E3E]/30 hover:text-red-500 transition-colors uppercase text-[7px] font-black tracking-[0.2em]">
                                    Remove
                                  </button>
                               </div>
                            </div>
                   ...
                   <div className="space-y-3">
                      {[
                        ...
                        <div 
                          ...
                          className={`p-6 border cursor-pointer transition-all flex items-center gap-6 relative ${
                        ...
                        >
                           <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center transition-all ${
                             selectedPayment === method.id ? 'border-brand-gold bg-brand-gold' : 'border-gray-100'
                           }`}>
